...
static void ComputeShaderColors( shaderStage_t *pStage, vec4_t baseColor, vec4_t vertColor, int blend )
{
	...
	switch ( pStage->rgbGen )
	{
		...
		case CGEN_ENTITY:
			...
			{
				baseColor[0] = backEnd.currentEntity->e.shaderRGBA.rgba[0] / 255.0f;
				baseColor[1] = backEnd.currentEntity->e.shaderRGBA.rgba[1] / 255.0f;
				baseColor[2] = backEnd.currentEntity->e.shaderRGBA.rgba[2] / 255.0f;
				baseColor[3] = backEnd.currentEntity->e.shaderRGBA.rgba[3] / 255.0f;
			}
			break;
		case CGEN_ONE_MINUS_ENTITY:
			if (backEnd.currentEntity)
			{
				baseColor[0] = 1.0f - backEnd.currentEntity->e.shaderRGBA.rgba[0] / 255.0f;
				baseColor[1] = 1.0f - backEnd.currentEntity->e.shaderRGBA.rgba[1] / 255.0f;
				baseColor[2] = 1.0f - backEnd.currentEntity->e.shaderRGBA.rgba[2] / 255.0f;
				baseColor[3] = 1.0f - backEnd.currentEntity->e.shaderRGBA.rgba[3] / 255.0f;
			}
			break;
		case CGEN_IDENTITY:
