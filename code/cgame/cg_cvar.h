...
CG_CVAR( cg_ignore, "cg_ignore", "0", 0 )
...
CG_CVAR( cg_megagibs, "cg_megagibs", "0", CVAR_ARCHIVE )
...
CG_CVAR( cg_crosshairSize, "cg_crosshairSize", "16", CVAR_ARCHIVE )
...
CG_CVAR( cg_runpitch, "cg_runpitch", "0.0", CVAR_ARCHIVE )
CG_CVAR( cg_runroll, "cg_runroll", "0.0", CVAR_ARCHIVE )
CG_CVAR( cg_bobup, "cg_bobup", "0.0", CVAR_CHEAT )
...
CG_CVAR( cg_drawFFABackground, "cg_drawFFABackground", "1", CVAR_ARCHIVE )
...
#endif
CG_CVAR( cg_vr_showOffhand, "vr_showOffhand", "1", CVAR_ARCHIVE )
...
CG_CVAR( cg_trueLightning, "cg_trueLightning", "0.2", CVAR_ARCHIVE )
