...
void main()
{
	...
	vec3 base = texture(texture0, vec3(tex_coord0, layer)).rgb * (6.0 / 16.0)
		+ texture(texture0, vec3(tex_coord1, layer)).rgb * (5.0 / 16.0)
		+ texture(texture0, vec3(tex_coord2, layer)).rgb * (5.0 / 16.0);
