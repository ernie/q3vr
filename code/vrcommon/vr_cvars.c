...
void VR_InitCvars( void )
{
	...
	// the grappling hook was skipped when this list was written; without the
	// ARCHIVE registration its adjustments lasted one session and vanished
	Cvar_Get ("vr_weapon_adjustment_10", "0.8,-2.75,6,-1.4,0,0,0", CVAR_ARCHIVE);
