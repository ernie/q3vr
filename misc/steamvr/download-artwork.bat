@echo off
REM Downloads official Quake 3 artwork from Steam CDN for SteamVR launcher icons.
REM Run this from your Q3VR install directory.

set CDN=https://steamcdn-a.akamaihd.net/steam/apps
